...
#def imageNo2d(self): 
 ...
 #   image_name_2d = "images/img2d-" + str(self.imageNo2d) + ".png"
    im.save("test1.png", "png") # Stored in images folder in the pwd, if not present then create one
  #  self.imageNo2d += 1
    im.show()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ip", type=str, default="192.168.1.144",
                        help="Robot IP address. On robot or Local Naoqi: use '192.168.1.144'.")
